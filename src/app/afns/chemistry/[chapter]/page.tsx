...
import { mcqs, chapters } from '@/lib/data/afns/chemistry';
...
export default async function AfnsChemistryTestPage({ params }: { params: Promise<{ chapter: string }> }) {
