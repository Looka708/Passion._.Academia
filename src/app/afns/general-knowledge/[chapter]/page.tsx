...
import { mcqs, chapters } from '@/lib/data/afns/general-knowledge';
...
export default async function AfnsGeneralKnowledgeTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = `/afns/general-knowledge`;
