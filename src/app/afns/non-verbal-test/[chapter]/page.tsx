...
import { mcqs, chapters } from '@/lib/data/afns/non-verbal-test';
...
export default async function AfnsNonVerbalTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = `/afns/non-verbal-test`;
