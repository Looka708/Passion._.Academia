...
import { syllabus } from "@/lib/data/afns";
import { ProtectedRoute } from "@/components/protected-route";

export default function AFNSPage() {
  return (
    <ProtectedRoute>
      ...
      <section className="container mx-auto px-4 py-12 sm:py-16 md:py-24">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            A comprehensive overview of the subjects covered in the Armed Forces Nursing Service entrance test, based on the Pakistan board curriculum.
          </p>
        </div>
                  ...
                  <Dialog>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Please choose between the Verbal and Non-Verbal test sections.
                        </DialogDescription>
                      </DialogHeader>
      ...
      <section className="bg-muted py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                Join Passion Academia's specialized AFNS test preparation course and get the expert guidance you need to succeed. Our structured program, expert faculty, and comprehensive mock tests will pave your way to success.
            </p>
            <div className="mt-8">
