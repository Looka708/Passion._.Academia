...
import { mcqs, chapters } from '@/lib/data/afns/urdu';
...
export default async function AfnsUrduTestPage({ params }: { params: Promise<{ chapter: string }> }) {
