...
import { mcqs, chapters } from '@/lib/data/afns/verbal-test';
...
export default async function AfnsVerbalTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = `/afns/verbal-test`;
