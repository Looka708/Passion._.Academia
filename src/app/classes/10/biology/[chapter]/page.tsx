...
import { mcqs, chapters } from '@/lib/data/class-10/biology';
...
export default async function Class10BiologyChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/10/biology";
