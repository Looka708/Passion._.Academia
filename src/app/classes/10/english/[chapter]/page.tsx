...
import { mcqs, chapters } from '@/lib/data/class-10/english';
...
export default async function Class10EnglishChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/10/english";
