...
import { mcqs, chapters } from '@/lib/data/class-10/mathematics';
...
export default async function Class10MathChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/10/mathematics";
