...
import { mcqs, chapters } from '@/lib/data/class-10/physics';
...
export default async function Class10PhysicsChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/10/physics";
