...
import { mcqs, chapters } from '@/lib/data/class-10/urdu';
...
export default async function Class10UrduChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/10/urdu";
