...
import { mcqs, chapters } from '@/lib/data/class-11/chemistry';
...
export default async function Class11ChemistryChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/11/chemistry";
