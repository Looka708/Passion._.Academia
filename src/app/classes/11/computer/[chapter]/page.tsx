...
import { mcqs, chapters } from '@/lib/data/class-11/computer';
...
export default async function Class11ComputerChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/11/computer";
