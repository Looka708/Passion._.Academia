...
import { mcqs, chapters } from '@/lib/data/class-11/english';
...
export default async function Class11EnglishChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/11/english";
