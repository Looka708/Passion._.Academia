...
import { mcqs, chapters } from '@/lib/data/class-11/mathematics';
...
export default async function Class11MathematicsChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/11/mathematics";
