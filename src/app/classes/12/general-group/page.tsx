...
export default function GeneralGroupPage() {
  const subjects = subjectsByStream["general-group"];
  return (
    <ProtectedRoute>
        ...
        <section className="container mx-auto px-4 py-12 sm:py-16 md:py-24">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-primary">
                Class 12 - General Group
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
                Specialized subjects in commerce, arts, and social sciences.
            </p>
            </div>
