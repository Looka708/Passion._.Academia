...
import { mcqs, chapters } from '@/lib/data/class-6/computer';
...
export default async function Class6ComputerChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/6/computer";
