...
import { mcqs, chapters } from '@/lib/data/class-6/english';
...
export default async function Class6EnglishChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/6/english";
