...
import { mcqs, chapters } from '@/lib/data/class-6/general-science';
...
export default async function Class6GeneralScienceChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/6/general-science";
