...
import { mcqs, chapters } from '@/lib/data/class-6/mathematics';
...
export default async function Class6MathChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/6/mathematics";
