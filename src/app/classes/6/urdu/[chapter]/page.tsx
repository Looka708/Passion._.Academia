...
import { mcqs, chapters } from '@/lib/data/class-6/urdu';
...
export default async function Class6UrduChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
