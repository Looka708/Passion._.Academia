...
import { mcqs, chapters } from '@/lib/data/class-7/computer';
...
export default async function Class7ComputerChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/7/computer";
