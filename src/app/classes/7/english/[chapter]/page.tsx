...
import { mcqs, chapters } from '@/lib/data/class-7/english';
...
export default async function Class7EnglishChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/7/english";
