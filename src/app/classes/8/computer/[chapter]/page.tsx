...
import { mcqs, chapters } from '@/lib/data/class-8/computer';
...
export default async function Class8ComputerChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/8/computer";
