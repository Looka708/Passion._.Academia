...
import { mcqs, chapters } from '@/lib/data/class-8/general-science';
...
export default async function Class8GeneralScienceChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/8/general-science";
