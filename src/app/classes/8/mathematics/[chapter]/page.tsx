...
import { mcqs, chapters } from '@/lib/data/class-8/mathematics';
...
export default async function Class8MathChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/8/mathematics";
