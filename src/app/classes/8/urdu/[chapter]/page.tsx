...
import { mcqs, chapters } from '@/lib/data/class-8/urdu';
...
export default async function Class8UrduChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
