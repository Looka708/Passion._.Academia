...
import { mcqs, chapters } from '@/lib/data/class-9/biology';
...
export default async function Class9BiologyChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/9/biology";
