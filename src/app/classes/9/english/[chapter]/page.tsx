...
import { mcqs, chapters } from '@/lib/data/class-9/english';
...
export default async function Class9EnglishChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/9/english";
