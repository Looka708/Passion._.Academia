...
import { mcqs, chapters } from '@/lib/data/class-9/mathematics';
...
export default async function Class9MathChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/9/mathematics";
