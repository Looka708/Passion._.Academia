...
import { mcqs, chapters } from '@/lib/data/class-9/physics';
...
export default async function Class9PhysicsChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = "/classes/9/physics";
