...
import { mcqs, chapters } from '@/lib/data/class-9/urdu';
...
export default async function Class9UrduChapterPage({ params }: { params: Promise<{ chapter: string }> }) {
