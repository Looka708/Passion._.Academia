...
import { mcqs, chapters } from '@/lib/data/mcj/english';
...
export default async function McjEnglishTestPage({ params }: { params: Promise<{ chapter: string }> }) {
