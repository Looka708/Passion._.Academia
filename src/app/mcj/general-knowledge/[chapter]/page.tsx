...
import { mcqs, chapters } from '@/lib/data/mcj/general-knowledge';
...
export default async function McjGeneralKnowledgeTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = '/mcj/general-knowledge';
