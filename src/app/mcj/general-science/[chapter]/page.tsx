...
import { mcqs, chapters } from '@/lib/data/mcj/general-science';
...
export default async function McjGeneralScienceTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = '/mcj/general-science';
