...
import { mcqs, chapters } from '@/lib/data/mcj/mathematics';
...
export default async function McjMathematicsTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = '/mcj/mathematics';
