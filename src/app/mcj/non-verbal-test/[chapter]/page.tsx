...
import { mcqs, chapters } from '@/lib/data/mcj/non-verbal-test';
...
export default async function McjNonVerbalTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = `/mcj/non-verbal-test`;
