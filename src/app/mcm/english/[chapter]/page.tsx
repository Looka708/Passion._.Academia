...
import { mcqs, chapters } from '@/lib/data/mcm/english';
...
export default async function McmEnglishTestPage({ params }: { params: Promise<{ chapter: string }> }) {
