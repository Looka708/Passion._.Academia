...
import { chapters } from "@/lib/data/mcm/general-knowledge";

const createSlug = (title: string) => {
  return title.toLowerCase().replace(/ /g, '-').replace(/:/g, '').replace(/\(/g, '').replace(/\)/g, '');
};

export default function McmGeneralKnowledgeChaptersPage() {
  return (
    <ProtectedRoute>
        ...
        <section className="container mx-auto px-4 py-12 sm:py-16 md:py-24">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-primary">
                MCM General Knowledge Chapters
            </h1>
            ...
            {chapters.map((chapter) => (
                ...
                <CardFooter>
                    ...
                    <Link href={`/mcm/general-knowledge/${createSlug(chapter)}`}>
