...
import { mcqs, chapters } from '@/lib/data/mcm/general-science';
...
export default async function McmGeneralScienceTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = '/mcm/general-science';
