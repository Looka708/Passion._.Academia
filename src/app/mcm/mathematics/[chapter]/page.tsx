...
import { mcqs, chapters } from '@/lib/data/mcm/mathematics';
...
export default async function McmMathematicsTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = '/mcm/mathematics';
