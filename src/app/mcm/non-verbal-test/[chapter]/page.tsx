...
import { mcqs, chapters } from '@/lib/data/mcm/non-verbal-test';
...
export default async function McmNonVerbalTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = `/mcm/non-verbal-test`;
