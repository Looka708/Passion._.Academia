...
import { syllabus } from "@/lib/data/mcm";
      ...
      <section className="container mx-auto px-4 py-12 sm:py-16 md:py-24">
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl text-primary">
            Military College Murree (MCM) Test
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            Begin your journey towards a distinguished career. Our program is designed to help you excel in the MCM entrance exam.
          </p>
        </div>
      ...
      <section className="bg-muted py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold tracking-tight">
                Prepare for a Future of Leadership at MCM
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
                Join our specialized course to build a strong academic foundation and develop the skills needed to pass the MCM entrance test with flying colors.
            </p>
            <div className="mt-8">
