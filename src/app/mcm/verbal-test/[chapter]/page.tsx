...
import { mcqs, chapters } from '@/lib/data/mcm/verbal-test';
...
export default async function McmVerbalTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = `/mcm/verbal-test`;
