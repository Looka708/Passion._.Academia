...
import { mcqs, chapters } from '@/lib/data/paf/general-knowledge';
...
export default async function PafGeneralKnowledgeTestPage({ params }: { params: Promise<{ chapter: string }> }) {
  ...
  const basePath = '/paf/general-knowledge';
