...
import { mcqs, chapters } from '@/lib/data/paf/physics';
...
export default async function PafPhysicsTestPage({ params }: { params: Promise<{ chapter: string }> }) {
